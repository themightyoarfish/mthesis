...
\citeauthor{raghu2017svcca} released the code used for the publication released
the code used for the publication.

Todo: Report difficulties with the GPU version and brag about the fact that
there is one at all.
...
directly from the call to \textt{forward()}, but since the only way PyTorch
